...
import Hero from 'features/Landing/components/Header';
import NumberBlock from 'features/Landing/components/NumberBlock';
import BrowserBlock from 'features/Landing/components/BrowserBlock';
...
import DemoBlock from 'features/Landing/components/DemoBlock';
import TestimonialBlock from 'features/Landing/components/TestimonialBlock';
import ElementBlock from 'features/Landing/components/ElementBlock';
import PartnerBlock from 'features/Landing/components/PartnerBlock';
    ...
    <>
      ...
      >
        <CardMedia
          ...
          image={`https://finasquare.s3.us-east-2.amazonaws.com/SATerminal/landing/bg-mockup-${presetColor}.png`}
          sx={{
            position: 'absolute',
