...
import SkeletonProductPlaceholder from '../../../../ui/components/cards/skeleton/ProductPlaceholder';
        ...
        <MainCard content={false} boxShadow sx={{ '&:hover': { transform: 'scale3d(1.02, 1.02, 1)', transition: 'all .4s ease-in-out' } }}>
          <Box sx={{ width: 250, m: 'auto' }}>
            <CardMedia
              ...
              image={image && `https://finasquare.s3.us-east-2.amazonaws.com/SATerminal/e-commerce/${image}`}
              component={Link}
