...
const imgfooterlogo = 'https://finasquare.s3.us-east-2.amazonaws.com/SATerminal/landing/codedthemes-logo.svg';
      ...
      {isFull && (
        ...
        >
          <CardMedia
            ...
            image={`https://finasquare.s3.us-east-2.amazonaws.com/SATerminal/landing/img-footer-${presetColor}.png`}
            sx={{
